...
:: Android packaging
set AND_CERT_NAME="SoundGame"
set AND_CERT_PASS=winwin128
set AND_CERT_FILE=cert\SoundGame.p12
...
set IOS_PROVISION=cert\SoundGame.mobileprovision
...
set APP_ID=air.SoundGame

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SoundGame
